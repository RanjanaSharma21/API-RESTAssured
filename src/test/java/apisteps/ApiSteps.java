...
public class ApiSteps {
    ...
    public void a_token_is_created() {
        ...
        // This saves the token safely inside your shared pipeline container map!
    ...
    public void a_request_is_prepared_to_create_an_employee_using_map_format() {
        ...
        request = given()
                .header("Authorization", token)
                .header("Content-Type", "application/json")
                .body(APIPayloadConstants.createEmployeePayloadMap());
    }
    ...
    public void the_map_request_body_must_match_the_response_body() {
        ...
        Map<String, Object> expectedData = APIPayloadConstants.createEmployeePayloadMap();
    ...
    public void a_request_is_prepared_to_create_an_employee_using_dynamic_json_format_with
        ...
        request = given()
                .header("Authorization", token)
                .header("Content-Type", "application/json")
                .body(APIPayloadConstants.createEmployeePayloadJsonDynamic(firstName, lastName, middleName, gender, birthday, jobTitle));
    }
    ...
    public void the_response_structure_must_match_the_employee_json_schema_blueprint() {
        ...
        response.then().assertThat()
                .body(io.restassured.module.jsv.JsonSchemaValidator.matchesJsonSchemaInClasspath("employee-schema.json"));
